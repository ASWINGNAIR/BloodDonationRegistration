...
function DonatedForm() {
  ...
  const validate = () => {
    ...
    if (!formData.dateOfDonation) newErrors.dateOfDonation = 'Date of donation is required.';
    return newErrors;
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(formErrors).length > 0) {
      ...
      setFormData({
        ...
        location: '',
        contact: '',
        dateOfDonation: '',  // Reset date of donation
      });
    }
  };
        ...
        <Modal.Body style={modalStyles.modalContent}>
          <div style={modalStyles.modalform} className="container mt-5 p-5 border rounded-3 shadow-lg">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                <label className="form-label fw-bold text-danger">Date of Donation:</label>
                <input
                  type="date"
                  name="dateOfDonation"  
                  ...
                  className="form-control"
                />
                {errors.dateOfDonation && <div className="text-danger mt-1">{errors.dateOfDonation}</div>}
              </div>
